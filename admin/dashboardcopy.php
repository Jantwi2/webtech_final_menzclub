...
<body>
    ...
    <script>        
        ...
        const products = ['Premium Leather Jacket', 'Designer Watch', 'Classic Suit', 'Sports Sneakers', 'Denim Collection'];
        const statuses = ['pending', 'completed', 'cancelled'];
        const customers = ['John Doe', 'Mike Smith', 'Alex Johnson', 'Chris Wilson', 'Robert Brown'];
